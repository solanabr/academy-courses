...
![Timeline from the reader's first mainnet curl in module one, through the Solana Pay repo redirecting to the Foundation pay repo, to the same redirect re-probed in the final lesson.](assets/v01-timeline.webp)
...
![Nine modules drawn as one left-to-right chain, from rails model through transfer kit, checkout surfaces, back office, subscriptions, fiat edge, machine payments, and production hardening, ending at the Wavelength capstone.](assets/v02-diagram.webp)
...
![Flowchart of the re-verification ritual: probe each moving pin, compare to the dated table, read the changelog on any change, and record a fresh dated note.](assets/v05-flowchart.webp)
