...
And the flat fee decides who gets to participate in that movement. The average cost of a $200 remittance through traditional corridors is cited at 6.6%, $13.20 gone per envelope home (same Helius guide, same fetch date). On these rails the network's cut of that $200 is the same fraction of a cent it charges on everything else. The builders moving fastest on these rails are the ones serving customers who count cents, because for the first time the fee math is on their side. Cheap rails do not just make existing payments cheaper. They change who the payments industry is for.

![Moving 200 dollars through a traditional remittance corridor costs 13 dollars 20 cents on average, while the Solana base fee stays below one cent.](assets/v04-chart.png)
...
Where do these rails fit best? Low-fee, cross-border, instant-settlement flows: the sales where percentage-based interchange eats the ticket, where correspondent banking eats days, where a multi-day settlement hold is the difference between making payroll and not. Where do they fit worst? Wherever reversibility is the product. If what your customer is really buying is the ability to change their mind after the money moves, sell them card rails. Knowing when not to use your new tool is not hedging. It is the model working.

![A two-column matrix: strong fit for cross-border, small-ticket, and instant-settlement flows; weak fit for high-fraud sales, businesses selling reversibility, and compliance regimes requiring an institutional undo.](assets/v06-comparison.png)
