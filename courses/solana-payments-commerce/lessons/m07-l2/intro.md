...
First, stand the workspace up. It sits beside the `backoffice` workspace from module 4, because the import path between them is the whole point of this lesson:
