...
2. **Kora-sponsored first purchase.** The buyer holds devnet USDC and zero SOL, and buys a record anyway. The fee payer on the landed transaction is the Kora signer, not the buyer. One receipt, and the paymaster diagram from module 8 is real. One receipt, and the paymaster diagram from module 8 is real.
