...
Run the arithmetic once so the row's cap is a number and not a shrug — it is the module-opening lesson's hundred-buyer napkin at fair scale: 200 sales cost 0.001 SOL of base fees for the entire day (a shade more once the sponsored sales below count their second signature), while 50 gasless first-timers needing fresh USDC token accounts cost about 0.1 SOL of sponsored rent, two orders of magnitude apart, every lamport of the rent reclaimable by buyers and none of it by you. The fee line in your books is really a sponsorship line, and the daily cap in the gate row is what keeps a scripted wave of fake first-time buyers from turning your growth budget into their rent farm.
