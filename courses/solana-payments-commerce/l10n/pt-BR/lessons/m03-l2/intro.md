...
![As duas formas de URL do Solana Pay lado a lado: a transfer request construída pela carteira expondo cada parâmetro, contra a transaction request construída pelo servidor carregando só um link e um id de pedido.](assets/v01-comparison.webp)
...
![Fluxograma de um carrinho guardado passando pelo QR, o GET da carteira atrás de label e icon, o POST da conta, a precificação no servidor, a carteira assinando e o watcher da reference confirmando.](assets/v02-flowchart.webp)
...
![Diagrama da transação devolvida: um envelope v0, o cliente como fee payer não assinado, um memo com o id do pedido e uma instrução TransferChecked carregando uma conta de reference readonly.](assets/v03-diagram.webp)
...
![As duas construções de código para os TODOs de completion: acrescentar a reference como conta readonly não signatária, e construir uma instrução de memo cujos dados são a string utf8 do pedido.](assets/v04-annotated-code.webp)
...
![Diagrama de confiança em três zonas: o servidor do lojista confiado só para construir, a carteira impondo que todo signatário exigido não assinado seja a conta submetida, e o cliente se apoiando nessa checagem.](assets/v05-diagram.webp)
...
![Linha do tempo da spec do Solana Pay de 2022, passando pela biblioteca de checkout virando um subpacote, até o repo de 2026 abrindo com um CLI de pagamentos agênticos.](assets/v06-timeline.webp)
...
![Diagrama do workspace, transfer-kit e checkout alimentando o checkout-txreq com seu catálogo, builder, servidor e smoke test, que a barraca da maquininha (POS), o blink do drop e o capstone consomem em lições posteriores.](assets/v07-diagram.webp)
