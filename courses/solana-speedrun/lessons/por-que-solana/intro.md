...
![Comparação em quatro linhas mostrando a Solana confirmando operações em menos de meio segundo e por menos de um centavo, à frente de PIX, TED e Ethereum.](assets/v01-comparison.png)
...
![Tabela resumindo os produtos que rodam na Solana (ações, ouro, crédito, cofres) e a lista de instituições que já construíram na rede, como Western Union, Visa, BlackRock e JPMorgan.](assets/v02-table.png)
...
![Gráfico de quatro números destacando que a Solana tem 54% do volume global de DEX, US$ 257 milhões de receita trimestral, 56% das transações reais e recorde de stablecoins.](assets/v03-chart.png)

![Escada de três degraus rotulados mostrando a velocidade real da Solana entre 1.000 e 4.000 por segundo, o teto teórico de 65.000 e a demonstração simulada de 1.000.000.](assets/v04-chart.png)
