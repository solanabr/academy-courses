...
![Um globo de máquinas conectadas forma um único megacomputador e libera três superpoderes para quem programa: publicar serviços financeiros globais 24 horas por dia, sem pedir permissão e com alcance mundial imediato.](assets/v01-diagram.webp)
...
![Um diagrama separa o programa, que é só código, das contas que guardam os dados, com uma carteira ligada a várias contas de saldo.](assets/v02-diagram.webp)
...
![Um fluxograma mostra transações independentes correndo em caixas paralelos ao mesmo tempo, enquanto as que disputam a mesma conta esperam na mesma fila.](assets/v03-flowchart.webp)
...
![Uma comparação mostra que na Solana só quem disputa o ingresso paga caro, enquanto no Ethereum um app concorrido encarece a taxa para todos.](assets/v04-comparison.webp)
...
![Um diagrama mostra o relógio criptográfico carimbando a ordem dos eventos primeiro, e só depois a rede votando sobre essa ordem já fixada.](assets/v05-diagram.webp)

![Um diagrama empilha os votos numa torre em que cada novo voto no topo dobra o tempo de bloqueio dos votos abaixo dele.](assets/v06-diagram.webp)
