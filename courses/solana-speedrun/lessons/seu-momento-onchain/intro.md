...
![Um fluxograma vertical mostra os quatro passos do claim, do toque no botão até apresentar o cNFT no balcão de brindes como ticket.](assets/v01-flowchart.webp)
...
![Um diagrama coloca o seu cNFT na mainnet no centro, marca a taxa patrocinada e a mesma infra das instituições, e aponta o stand de onramp.](assets/v02-diagram.webp)
...
![Uma tabela lista os quatro poderes destravados pelo onramp: negociar em DEX, emprestar em protocolos de lending, render em vaults da Kamino e prover liquidez na Meteora.](assets/v03-table.webp)
...
![Um fluxograma leva o PIX do stand de onramp até a stablecoin na carteira e mostra três caminhos: guardar, render na vault da Kamino ou prover liquidez na Meteora.](assets/v04-flowchart.webp)
