...
//                                                         -> Err("missing key: <k>")
//
// parse_kv returns Result, errors are values, exactly like m04-l2 taught. It
// lives nested inside parse_target, the graded entry point and this file's
// one top-level fn, which renders the Result as "OK <name> <url> <timeout_ms>"
// or "ERR <message>". Leave the nesting as it is and fix parse_kv in place.
//
