...
// The helpers are nested inside `latency_report` on purpose, leave them
// nested: a nested fn is an ordinary function (no captures), and the graded
// entry point stays this file's one top-level `fn`.
//
