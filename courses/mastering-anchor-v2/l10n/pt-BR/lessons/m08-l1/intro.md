...
Mais uma direção, para você saber para onde este cliente vai em seguida. Conseguir uma transação bem-formada *montada* é esta lição. Conseguir que ela *aterrisse* de forma confiável sob carga, taxas de prioridade, retentativas, a arte inteira do pouso de transação, fica além da fronteira do lado cliente. Este curso é dono do framework e da interface, e repassa a estratégia de pouso para o outro lado dessa linha.
