...
![El floor-registry se sienta en el centro con una flecha de CPI hacia cada uno de los cuatro peldaños, más una segunda flecha que muestra la liquidación del premio como una llamada de dos saltos.](assets/v01-diagram.webp)
...
![Una tabla de tres columnas que compara cada pieza de una llamada de CPI entre las líneas de Anchor, subrayando que las lecturas obsoletas-después-de-CPI se volvieron un error de compilación en V2.](assets/v02-comparison.webp)
...
![Una pila vertical que muestra settle_prize anidándose a través de floor-registry, prize-escrow, quarter-vault y el token program, llegando a altura de pila 4 sobre el máximo de 5.](assets/v03-diagram.webp)
...
![Una tarjeta de código anotada que aísla las tres partes reutilizables de una CPI de V2, con la regla de leer el estado tipado antes de abrir un handle.](assets/v04-annotated-code.webp)
...
No estás persiguiendo cobertura total en un capstone, solo demostrando que el banco de pruebas corre contra tu composición y que un target vuelve en verde.
...
![Un pipeline de ocho etapas que va desde anchor build pasando por la suite de unidad, fuzz, harden, profile de CU, localnet de Surfpool, deploy en devnet, y verify-desde-el-repo local.](assets/v05-flowchart.webp)
...
![Una línea de tiempo de dos carriles que separa la demostración local de reproducibilidad contra devnet de los pasos de distribución y autoridad exclusivos de mainnet, que se demuestran pero nunca se corren acá.](assets/v06-timeline.webp)
...
![Una tabla de dos columnas con la lista de cierre, que enumera cada etapa del capstone y su señal concreta de aprobado, desde la suite de unidad en verde pasando por la corrida de localnet en Surfpool, el deploy en devnet, y el verify-desde-el-repo que coincide.](assets/v07-comparison.webp)
