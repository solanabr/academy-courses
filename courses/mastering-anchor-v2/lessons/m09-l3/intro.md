...
You are not chasing full coverage in a capstone, only proving the harness runs against your composition and one target comes back green.
...
That is the ladder, top to bottom. You built a counter and felt the deserialize tax disappear. You gave it custody, then a condition, then a price. You hardened it, fuzzed it, profiled it, and shipped it. And now you have composed all of it into one program that runs the whole floor and proved, from your own source, that the thing on devnet is the thing you wrote. Worth sitting with for a second. Five programs, four of which you wrote from a blank file, composed by a fifth, proven byte-for-byte against the source you can publish. That is the shape of a real deployment, not a tutorial artifact.
