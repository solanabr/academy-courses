...
![Eternal is open from November to March and June to August with a semi-annual US$25,000 USDC award, so a mid-October hackathon deadline puts the announcement inside the window that has already opened.](assets/v02-timeline.webp)
...
![A lost pitch can return to the next Colosseum season under the same checklist, to Eternal only if materially changed, to Foundation grants as a public good, to Earn for the Brazil grant and bounties, and to the accelerator only through an interview.](assets/v03-table.webp)
