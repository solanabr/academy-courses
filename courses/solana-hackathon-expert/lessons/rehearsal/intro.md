...
![The rehearsal plan holds four lines copied from the edition's page, what is handed in, the deadline with its timezone, who is in the room and how the prize is paid, plus the editions refused with a reason.](assets/v01-table.webp)
...
![The Colosseum package is exported to a rehearsal edition, tested on three things in front of a panel, changed once from the scores and submitted to Colosseum, never rebuilt.](assets/v02-flowchart.webp)
...
![The path runs from a dated seasonal placement to an expected side track, a least crowded sponsor track chosen by the kit, and the global Colosseum submission.](assets/v03-flowchart.webp)
