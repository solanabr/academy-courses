...
Pool composition, routing across venues, tick and bin math, LP strategy, and everything else that makes a swap efficient rather than merely possible is the DeFi and RWA Engineering course's material. I am not going to give you a shallow version of a subject that has a proper home.
